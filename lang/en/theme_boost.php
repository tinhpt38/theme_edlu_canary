...
$string['choosereadme'] = 'canary is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'canary';
...
$string['privacy:metadata'] = 'The canary theme does not store any personal data about any user.';
