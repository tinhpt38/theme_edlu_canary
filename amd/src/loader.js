...
define(['jquery', './tether', 'core/event', 'core/custom_interaction_events'], function(jQuery, Tether, Event, customEvents) {
    ...
    M.util.js_pending('theme_canary/loader:children');

    require(['theme_canary/aria',
            'theme_canary/pending',
            'theme_canary/util',
            'theme_canary/alert',
            'theme_canary/button',
            'theme_canary/carousel',
            'theme_canary/collapse',
            'theme_canary/dropdown',
            'theme_canary/modal',
            'theme_canary/scrollspy',
            'theme_canary/tab',
            'theme_canary/tooltip',
            'theme_canary/popover'],
            function(Aria) {
        ...
        Aria.init();
        M.util.js_complete('theme_canary/loader:children');
    });
